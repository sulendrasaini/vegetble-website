...
const Headings = (props) => {
  return (
    ...
    <div className='max-w-[1400px] mx-auto w-fit'>
      <h1 className='md:text-5xl text-[2.3rem] font-bold md:py-6 py-2 '><span className='bg-gradient-to-b from-green-700 to-green-950 bg-clip-text text-transparent'>{props.highLight}</span> {props.normalWord}</h1>
